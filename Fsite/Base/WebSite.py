...
class WebSite(object):
    ...
    def delete(self, name_of_site):
        self.website_model.delete(name_of_site)
    ...
    def sync_db_with_dir(self, identifier):
        ...
        manifest_files_to_delete_from_db = [_file for _file in manifest_files_in_db if
                                            not _file in manifest_files_in_dir]
        ...
        separate_files_to_delete_from_db = [_file for _file in separate_files_in_db if
                                            not _file in separate_files_in_dir]
